            ...
            <x-slot name="content">
                ...
                <form wire:submit.prevent="createPost">
                   ...
                   <div class="mt-4">
                        ...
                        {{-- <textarea name="body" rows="10" class="block w-full mt-1 border-gray-300 focus:border-cyan-500 focus:ring focus:ring-cyan-200 focus:ring-opacity-50 rounded-md shadow-sm" wire:model.debounce.2000ms="body" placeholder="Your text here" id="body">
                        </textarea> --}}
                        <div id="body" name="body" wire:model.debounce.2000ms="body"></div>
